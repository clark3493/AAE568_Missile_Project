...
X_dis = linspace(X_min,X_max, 21);
Z_dis = linspace(Z_min, Z_max,21);
...
for i = 1:100
    ...
    main_path = 'C:\Users\Reese Robinson\Desktop\Purdue\AAE 568 Applied Optimal Control and Estimation\Project\C DP Program\data\';
    tf_value = 'tf4';
